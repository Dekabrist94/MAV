      ...
      <section className="PhotoTools">
        ...
        <div className="cardContainer">
          <div className="card cardBorder">
            <img className="cardStyle" width={60} height={60} src={Drone} alt="card" />
            <p className="cardStyle">TEXT</p>
          </div>
          <div className="card cardBorder">
            <img className="cardStyle" width={60} height={60} src={Mark} alt="card" />
            <p className="cardStyle">TEXT</p>
          </div>
          <div className="card cardBorder">
            <img className="cardStyle" width={60} height={60} src={CanonD} alt="card" />
            <p className="cardStyle">TEXT</p>
          </div>
          <div className="card cardBorder">
            <img className="cardStyle" width={60} height={60} src={Lumix} alt="card" />
            <p className="cardStyle">TEXT</p>
          </div>
          <div className="card cardBorder">
            <img className="cardStyle" width={60} height={60} src={Hero5} alt="card" />
            <p className="cardStyle">TEXT</p>
          </div>
        </div>
      </section>
