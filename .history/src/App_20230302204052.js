      ...
      <section className="PhotoTools">
        ...
        <div className="cardContainer">
          <div className="card cardBorder">
            <img className="cardStyle" width={80} height={80} src={Drone} alt="card" />
            <p className="cardStyle">TEXT</p>
          </div>
          <div className="card cardBorder">
            <img className="cardStyle" width={80} height={80} src={Mark} alt="card" />
            <p className="cardStyle">TEXT</p>
          </div>
          <div className="card cardBorder">
            <img className="cardStyle" width={80} height={80} src={CanonD} alt="card" />
            <p className="cardStyle">TEXT</p>
          </div>
          <div className="card cardBorder">
            <img className="cardStyle" width={80} height={80} src={Lumix} alt="card" />
            <p className="cardStyle">TEXT</p>
          </div>
          <div className="card cardBorder">
            <img className="cardStyle" width={80} height={80} src={Hero5} alt="card" />
            <p className="cardStyle">TEXT</p>
          </div>
        </div>
      </section>
