      ...
      <section className="PhotoTools">
        ...
        <div>
          <div className="cardContainer">
            <img width={120} height={120} src={Drone} alt="cardContainer" />
            <p>TEXT</p>
          </div>
          <div className="cardContainer">
            <img width={180} height={120} src={Mark} alt="cardContainer" />
            <p>TEXT</p>
          </div>
          <div className="cardContainer">
            <img width={100} height={120} src={CanonD} alt="cardContainer" />
            <p>TEXT</p>
          </div>
          <div className="cardContainer">
            <img width={120} height={120} src={Lumix} alt="cardContainer" />
            <p>TEXT</p>
          </div>
          <div className="cardContainer">
            <img width={120} height={120} src={Hero5} alt="cardContainer" />
            <p>TEXT</p>
          </div>
        </div>
      </section>
