  ...
  return (
    <section className="aboutMe">
      ...
      <h4 className="textAbout">
        <h1 className="textAboutCenter"></h1>About Me:</h1> Welcome to MAV photographer Alex website! I am Professional photographer,
        videographer, also i do video and photo by Drone. All my:
