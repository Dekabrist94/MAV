  ...
  return (
    <div className="wrapper">
      ...
      <div className="aboutMe">
        ...
        <div>
          <h1 className="textAbout">Обо Мне:</h1>
          <h4 className="textAbout">
            Welcome to MAV photographer Alex website! I am Professional photographer, videographer,
            my expiriens is 5 yers with hard job and still study any new fitches. If you want to see
            my <a>Portfolio</a>, you can do it in two things: On <a>Instagram</a> or scroll a bit
            down to site and you will find all my best jobs. Kind regards!!!
          </h4>
        </div>
      </div>
    </div>
