      ...
      <section className="PhotoTools">
        ...
        <div className="cardContainer">
          <div className="card cardBorder">
            ...
            <p className="cardStyle">DJI Mavic Air</p>
          </div>
          <div className="card cardBorder">
            <img className="cardStyle" width={140} height={120} src={Mark} alt="card" />
            <p className="cardStyle">Canon 5D Mark II</p>
          </div>
          <div className="card cardBorder">
            <img className="cardStyle" width={140} height={120} src={CanonD} alt="card" />
            <p className="cardStyle">Canon EOS 1000D</p>
          </div>
          <div className="card cardBorder">
            <img className="cardStyle" width={140} height={120} src={Lumix} alt="card" />
            <p className="cardStyle">Panasonic Lumix g7</p>
          </div>
          <div className="card cardBorder">
            <img className="cardStyle" width={140} height={120} src={Hero5} alt="card" />
            <p className="cardStyle">GoPro HEro 5</p>
          </div>
        </div>
      </section>
    </div>
